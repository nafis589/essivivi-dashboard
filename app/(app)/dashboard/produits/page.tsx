...
export default function ProduitsPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1400px]">
      ...
      {/* ── Table Container directly embedded via transparent/subtle bg ───── */}
                ...
                return (
                  <React.Fragment key={product.id}>
                    ...
                    >
                      ...
                      <TableCell className="text-sm font-semibold text-slate-700">{product.brand}</TableCell>
                      <TableCell className="text-sm font-bold text-slate-700">{product.price}</TableCell>
                      <TableCell className="text-sm font-medium text-slate-600">{product.stock}</TableCell>
                      <TableCell className="text-sm font-medium text-slate-600">{product.sales}</TableCell>
                      <TableCell className="text-right pr-6">
                        <Badge
                          variant="secondary"
                          className={`px-2 py-0.5 rounded-md font-medium text-[11px] border-0 capitalize ${product.status === 'Active'
