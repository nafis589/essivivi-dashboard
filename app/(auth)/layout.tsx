          ...
          <div className="relative z-10 flex flex-col justify-between w-full h-full p-12 text-primary-foreground">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <h1 className="font-semibold text-2xl tracking-tight">FlowCommerce</h1>
              </div>
              <p className="text-primary-foreground/80 font-medium text-lg">Design. Build. Launch. Repeat.</p>
            </div>
            ...
            <div className="flex w-full justify-between items-end gap-6">
              <div className="flex-1 space-y-1.5">
                ...
                <p className="text-sm text-primary-foreground/70 leading-relaxed">
                  Connectez-vous pour accéder à votre inventaire, gérer vos clients et suivre vos performances en temps réel.
                </p>
              </div>
              ...
              <div className="flex-1 space-y-1.5">
                ...
                <p className="text-sm text-primary-foreground/70 leading-relaxed">
                  Notre équipe de support est là pour vous accompagner à chaque étape de votre croissance.
                </p>
              </div>
            </div>
          </div>
