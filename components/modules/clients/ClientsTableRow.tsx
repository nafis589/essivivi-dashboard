...
export function ClientsTableRow({ client, onView, onEdit, isSelected }: ClientsTableRowProps) {
    return (
        <TableRow
            className={cn(
        ...
        >
            ...
            <TableCell className="hidden lg:table-cell text-center py-4 px-6">
            ...
            <TableCell className="font-semibold text-slate-900 tabular-nums text-right md:text-left py-4 px-6">
